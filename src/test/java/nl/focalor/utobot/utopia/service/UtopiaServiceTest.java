...
public class UtopiaServiceTest {
	...
	public void testDateRealToUtopian() throws ParseException {
		...
		assertThat(utopiaService.getUtopianDateFromRealDate(parsedDate).toString(false),
				is(equalTo("February 22, YR9")));
	}

	@Test
	public void testDateUtopiaToReal() throws ParseException {
		SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");
		Date parsedDate = formatter.parse("01-04-2015 19:00:05");
	...
	public void testgetUtopiaDateFromString() throws ParseException {
		...
		utopianDate.setMonth(1);
		utopianDate.setDay(23);
		assertThat(utopiaService.getUtopiaDateFromString(stringDate).toString(false),
				is(equalTo(utopianDate.toString(false))));
	}
}
